...
if __name__ == "__main__":
    ...
    # json_file = "/home/aiarhipov/datasets/WTW-dataset/train/train_4.json"
    # parseXmlFiles(xml_path, four_boxes=True)
    ...
    # xml_path = ["/home/aiarhipov/datasets/WTW-dataset/train/xml"]
    # json_file = "/home/aiarhipov/datasets/WTW-dataset/train/train_4x2.json"
    # parseXmlFiles(xml_path, four_boxes=True, div=2)
    # json.dump(coco, open(json_file, "w"))

    # xml_path = ["/home/aiarhipov/datasets/WTW-dataset/test/xml"]
    # json_file = "/home/aiarhipov/datasets/WTW-dataset/test/test_4x2.json"
    # parseXmlFiles(xml_path, four_boxes=True, div=2)
    # json.dump(coco, open(json_file, "w"))
