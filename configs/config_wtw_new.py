TEST_NAME = "new_conf__auto_scale_lr"
...
load_from = "/home/aiarhipov/MM/tutorial_exps/epoch_56.pth"
resume_from = None
...
# LEARNING POLICY
runner = dict(
    type="EpochBasedRunner", max_epochs=56
...
lr_config = dict(
    ...
    warmup_iters=1000,
    warmup_ratio=0.001,
    step=[10, 20, 30, 40, 50],  # the real step is [18*5, 24*5]
)
