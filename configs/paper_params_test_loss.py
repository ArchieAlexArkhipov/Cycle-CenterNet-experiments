TEST_NAME = "paper_params_test_loss"
...
load_from = "/home/aiarhipov/MM/checkpoints/centernet_resnet18_dcnv2_140e_coco_20210702_155131-c8cd631f.pth"
resume_from = None
...
model = dict(
    ...
    train_cfg=None,
    test_cfg=dict(topk=2000, local_maximum_kernel=1, max_per_img=2000),
)
...
# LOGGING
work_dir = "/home/aiarhipov/MM/exps/" + TEST_NAME
